...
enCompareResult CompareTwoDates(stDate Date1, stDate Date2)
{
	if (isDate1AfterDate2(Date1, Date2))
		return enCompareResult::eAfter;
	else if (isDate1EqualDate2(Date1, Date2))
		return enCompareResult::eEqual;
	else
		return enCompareResult::eBefore;
}
...
int main()
{
	...
	std::cout << "Compare Result: " << CompareTwoDates(Date1, Date2) << std::endl;
