...
int main()
{
	...
	std::cout << "Vacation From: " << DayShortName(DayOfWeekOrder(DateFrom))
		<< ", " << DateFrom.Day << "/" << DateFrom.Month << "/" << DateFrom.Year << std::endl;

	std::cout << "Vacation To: " << DayShortName(DayOfWeekOrder(DateTo))
		<< ", " << DateTo.Day << "/" << DateTo.Month << "/" << DateTo.Year << std::endl;

	std::cout << "\nActual Vacation Days is: " << CalculateVacationDays(DateFrom, DateTo) << std::endl;
