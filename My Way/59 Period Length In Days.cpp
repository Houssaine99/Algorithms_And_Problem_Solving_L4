...
{
	if (CompareDates(Period2.EndDate, Period1.StartDate) == enDatesCompare::eBefore
		|| CompareDates(Period2.StartDate, Period1.EndDate) == enDatesCompare::eAfter)
		return false;
	else
		return true;
}
...
int main()
{
	...
	std::cout << "Period Length is: " << GetDifferenceInDays(Period1.StartDate, Period1.EndDate) << std::endl;
	std::cout << "Period Length (Including End Date): " << GetDifferenceInDays(Period1.StartDate, Period1.EndDate, true) << std::endl;
