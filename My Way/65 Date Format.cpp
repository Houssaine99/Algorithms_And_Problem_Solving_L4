...
std::string FormatDate(stDate Date, enDateFormat Format)
{
	switch (Format)
	{
	...
	case enDateFormat::SeperatedFormat:
...
{ 
	...
	std::cout << std::endl << FormatDate(Date, enDateFormat::DayMonthYear) << std::endl;
	std::cout << std::endl << FormatDate(Date, enDateFormat::YearDayMonth) << std::endl;
	std::cout << std::endl << FormatDate(Date, enDateFormat::MonthDayYear) << std::endl;
	std::cout << std::endl << FormatDate(Date, enDateFormat::MonthDayYearDash) << std::endl;
	std::cout << std::endl << FormatDate(Date, enDateFormat::DayMonthYearDash) << std::endl;
	std::cout << std::endl << FormatDate(Date, enDateFormat::SeperatedFormat) << std::endl;
